...
file_paths = {
    "100": "solid-login-100-2025-07-08T08-49-17.992Z.txt",
}
...
df_results = df_results.sort_values(by="Iterations")
df_results = df_results.round(3)

output_dir = "metrics"
os.makedirs(output_dir, exist_ok=True)

output_path = os.path.join(output_dir, "solid_login_100_iterations_summary.csv")
